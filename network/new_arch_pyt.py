...
def myNetwork():
    ...
    info( '*** Add hosts\n')
    h4 = net.addHost('h4', cls=Host, ip='10.10.1.4', defaultRoute=None)
    h2 = net.addHost('h2', cls=Host, ip='10.10.1.2', defaultRoute=None)
    h5 = net.addHost('h5', cls=Host, ip='10.10.1.5', defaultRoute=None)
    h3 = net.addHost('h3', cls=Host, ip='10.10.1.3', defaultRoute=None)
    h6 = net.addHost('h6', cls=Host, ip='10.10.1.6', defaultRoute=None)
